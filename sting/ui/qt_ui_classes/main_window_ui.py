...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.acq_pos_bar = QtWidgets.QProgressBar(self.verticalLayoutWidget)
        self.acq_pos_bar.setProperty("value", 24)
        self.acq_pos_bar.setObjectName("acq_pos_bar")
        self.acquisition.addWidget(self.acq_pos_bar)
        ...
        self.segmentation = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.segmentation.setContentsMargins(0, 0, 0, 0)
        self.segmentation.setObjectName("segmentation")
        self.seg_process_label = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.seg_process_label.setFont(font)
        self.seg_process_label.setAlignment(QtCore.Qt.AlignCenter)
        self.seg_process_label.setObjectName("seg_process_label")
        self.segmentation.addWidget(self.seg_process_label)
        self.seg_pos_label = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.seg_pos_label.setFont(font)
        self.seg_pos_label.setAlignment(QtCore.Qt.AlignCenter)
        self.seg_pos_label.setObjectName("seg_pos_label")
        self.segmentation.addWidget(self.seg_pos_label)
        self.seg_pos_bar = QtWidgets.QProgressBar(self.verticalLayoutWidget_2)
        self.seg_pos_bar.setProperty("value", 24)
        self.seg_pos_bar.setObjectName("seg_pos_bar")
        self.segmentation.addWidget(self.seg_pos_bar)
        self.seg_n_pos = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.seg_n_pos.setReadOnly(True)
        self.seg_n_pos.setObjectName("seg_n_pos")
        self.segmentation.addWidget(self.seg_n_pos)
        self.seg_time_label = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.seg_time_label.setFont(font)
        self.seg_time_label.setAlignment(QtCore.Qt.AlignCenter)
        self.seg_time_label.setObjectName("seg_time_label")
        self.segmentation.addWidget(self.seg_time_label)
        self.seg_time_bar = QtWidgets.QProgressBar(self.verticalLayoutWidget_2)
        self.seg_time_bar.setProperty("value", 24)
        self.seg_time_bar.setObjectName("seg_time_bar")
        self.segmentation.addWidget(self.seg_time_bar)
        self.seg_n_time = QtWidgets.QLineEdit(self.verticalLayoutWidget_2)
        self.seg_n_time.setReadOnly(True)
        self.seg_n_time.setObjectName("seg_n_time")
        self.segmentation.addWidget(self.seg_n_time)
        ...
        self.tracking = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.tracking.setContentsMargins(0, 0, 0, 0)
        self.tracking.setObjectName("tracking")
        self.track_label = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.tracking.addWidget(self.track_label)
        self.track_pos_label = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.track_pos_label.setFont(font)
        self.track_pos_label.setAlignment(QtCore.Qt.AlignCenter)
        self.track_pos_label.setObjectName("track_pos_label")
        self.tracking.addWidget(self.track_pos_label)
        self.track_pos_bar = QtWidgets.QProgressBar(self.verticalLayoutWidget_3)
        self.track_pos_bar.setProperty("value", 24)
        self.track_pos_bar.setObjectName("track_pos_bar")
        self.tracking.addWidget(self.track_pos_bar)
        self.track_n_pos = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.track_n_pos.setReadOnly(True)
        self.track_n_pos.setObjectName("track_n_pos")
        self.tracking.addWidget(self.track_n_pos)
        self.track_time_label = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.track_time_label.setFont(font)
        self.track_time_label.setAlignment(QtCore.Qt.AlignCenter)
        self.track_time_label.setObjectName("track_time_label")
        self.tracking.addWidget(self.track_time_label)
        self.track_time_bar = QtWidgets.QProgressBar(self.verticalLayoutWidget_3)
        self.track_time_bar.setProperty("value", 24)
        self.track_time_bar.setObjectName("track_time_bar")
        self.tracking.addWidget(self.track_time_bar)
        self.track_n_time = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.track_n_time.setReadOnly(True)
        self.track_n_time.setObjectName("track_n_time")
        self.tracking.addWidget(self.track_n_time)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.seg_process_label.setText(_translate("MainWindow", "Segmentation"))
        self.seg_pos_label.setText(_translate("MainWindow", "Positions"))
        self.seg_time_label.setText(_translate("MainWindow", "Time points"))
        self.track_label.setText(_translate("MainWindow", "Tracking"))
        self.track_pos_label.setText(_translate("MainWindow", "Positions"))
        self.track_time_label.setText(_translate("MainWindow", "Time points"))
